  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `HTTP Error: ${response.status}, Details: ${errorDetails}`
        );
      }

      const data = await response.json();

      // Validate and extract generated image
      ...
      console.error("Error in generateImage function:", error.message);
      alert(error.message);
    } finally {
